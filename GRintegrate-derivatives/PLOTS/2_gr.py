...
def plot_gr_inset(gr,filename=ext_name):
    ...
    with open(filename, 'w') as file:
        ...
        combined_legend = plt.legend([dummy_line], ['$L \\to \\infty$'],
                                     fontsize=legend_fontsize, loc=3, ncol=1,
...
with plt.style.context([ 'ieee']):
    ...
    ax_inset.set_xlim(0, 0.07)  # X-axis limit for zoom
    ax_inset.set_ylim(-2.07, -2.01)   # Y-axis limit for zoom
    
    ax_inset.xaxis.set_major_locator(MultipleLocator(0.02))
    ax_inset.xaxis.set_minor_locator(MultipleLocator(0.01))
    ax_inset.yaxis.set_major_locator(MultipleLocator(0.02))
    ax_inset.yaxis.set_minor_locator(MultipleLocator(0.01))
