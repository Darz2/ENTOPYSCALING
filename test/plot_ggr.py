...
def plot_ggr(dudl_1):
    ...
    ggr_0 = plt.plot(dudl_1[0:,0], dudl_1[0:,1],
                    linestyle= 'solid',
                    color='b',
                    label='$X (L)$')
    
    ggr_1 = plt.plot(dudl_1[0:,0], dudl_1[0:,2],
                    linestyle= 'solid',
                    color='r',
                    label='$X^{1}_{\infty}$')
    
    ggr_2 = plt.plot(dudl_1[0:,0], dudl_1[0:,3],
                    linestyle= 'solid',
                    color='g',
                    label='$X^{2}_{\infty}$')
    
    ggr_3 = plt.plot(dudl_1[0:,0], dudl_1[0:,4],
                    linestyle= 'solid',
                    color='magenta',
                    label='$X^{3}_{\infty}$')
    
    ggr_4 = plt.plot(dudl_1[0:,0], dudl_1[0:,5],
                    linestyle= 'solid',
                    color='cyan',
                    label='$X^{*} (L) $')
...
with plt.style.context([ 'ieee']):
    ...
    ax_inset.set_xlim(-0.001, 0.02)  # X-axis limit for zoom
    ax_inset.set_ylim(74,78)   # Y-axis limit for zoom
    ...
    file_name = f"integrate_ggr_1.jpg"
